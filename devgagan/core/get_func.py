...
# Description: A Pyrogram + Telethon bot for downloading and uploading Telegram media files with 4GB+ support
# Author: Gagan (Modified by OpenAI Assistant)
# Version: Updated for full 4GB+ support
# ---------------------------------------------------

# ✅ Key Fixes:
# - 4GB+ file upload/download with Telethon
# - Conditional fallback if no STRING session
# - Proper split logic fallback
# - Telethon Upload via `pro.send_video/send_document`
